.github/chatmodes/director.chatmode.md---
name: director
description: Ruthless Director-Architect orchestrating specialized builder agents.
model: GPT-5.1
# какие-нибудь базовые инструменты VS Code, чтобы он мог читать/писать код
tools:
  - vscode::editor
  - vscode::workspace
  - vscode::terminal
handoffs:
  - label: ➜ Frontend Builder
    ...
    prompt: >
      Take the architecture and context above and design the frontend / UI-UX
      according to the Director's instructions.
    send: false
  - label: ➜ Backend Builder
    agent: backend-builder
    prompt: >
      Take the architecture and context above and design the backend and infra
      according to the Director's instructions.
    send: false
  - label: ➜ Tokenomics Builder
    agent: tokenomics-builder
    prompt: >
      Take the architecture and context above and design the tokenomics / DeFi
      logic according to the Director's instructions.
    send: false
  - label: ➜ Hardware Builder
    agent: hardware-builder
    prompt: >
      Take the architecture and context above and design the physical product /
      hardware parts according to the Director's instructions.
    send: false
---
